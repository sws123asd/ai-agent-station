...
public class AutoAgentTest {
    ...
    private static String baiduSearch = "bce-v3/ALTAK-1raWJKUmslEajz3ShtwQP/46937adc1e78d5421171d01b2abcf86b44f24ebc";
    @Before
    public void init() {

        OpenAiApi openAiApi = OpenAiApi.builder()
//                .baseUrl("https://apis.itedus.cn")
//                .apiKey("sk-jNwXKo0k8fXUJVwd8b05841880D041F89b1d8949C2AfBeA4")
                .baseUrl("https://dashscope.aliyuncs.com/compatible-mode")
                .apiKey("sk-e849ea6093c948cfa02648d0a4a9063a")
...
//                                .build()),
    ...
    public void test_search_agent() {
        ChatResponse chatResponse = chatModel.call(Prompt.builder()
                .messages(new UserMessage("搜索溱洧水城的信息"))
                .build());
        log.info("搜索结果：{}", chatResponse.getResult());
    }
    ...
    public void test_complete_auto_agent_workflow() {
        ...
        log.info("Execution 执行上下文: {}", executionContext);
        ...
        log.info("总结报告上下文: {}", summaryContext);
    ...
    public void test_dynamic_multi_step_execution() {
        int maxSteps = 4;
        String userInput = "搜索 Spring AI 最新相关知识，生成4个主要内容章节。每个章节要包括课程内容和配套示例代码。并创建对应章节md文档在 /Users/joyboy/Desktop 下，方便小白伙伴学习。";
    ...
    public McpSyncClient sseMcpClient() {
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://appbuilder.baidu.com/v2/ai_search/mcp/")
                .sseEndpoint("sse?api_key=bce-v3/ALTAK-1raWJKUmslEajz3ShtwQP/46937adc1e78d5421171d01b2abcf86b44f24ebc")
                .build();
    ...
    public McpSyncClient stdioMcpClient() {
        var stdioParams = ServerParameters.builder("npx")
                .args("-y", "@modelcontextprotocol/server-filesystem", "/Users/joyboy/Desktop", "/Users/joyboy/Coding/project/springAI/ai-agent/ai-agent-station/ai-agent-station-app")
                .build();
